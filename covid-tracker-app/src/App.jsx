        ...
        <div className="row">
          <div className="col-md-8 mx-auto mt-4">
            ...
            <input
              ...
              className="form-control" onChange={(e) => setTarih(e.target.value)}
            />
            <table class="table table-striped text-white">
              ...
              <tbody>
                <tr className="text-white">
                  ...
                  <td className={veri===undefined ? "bg-danger" : "bg-warning"}>{veri===undefined ? "Veri Bekleniyor..." : veri.deaths}</td>
                </tr>
              </tbody>
            </table>
          </div>
